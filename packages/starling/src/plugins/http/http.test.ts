...
async function createTestHttpDb(
	pluginOptions: Partial<
		Parameters<typeof httpPlugin>[0]
	> = {},
...
function mockSuccessfulGet(document: StarlingDocument<AnyObject> = makeEmptyDocument()) {
...
function mockSuccessfulPatch(document: StarlingDocument<AnyObject> = makeEmptyDocument()) {
